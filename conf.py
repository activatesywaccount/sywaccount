...
project = 'activate.syw.accountonline.com – SYW Card Activation'
copyright = '2025, activate.syw.accountonline.com'
author = 'SYW Account Online Help Center'
...
# Hides the "View page source" link
